...
class Interface:
    ...
    def info(self, message):
        ...
        self.console.info(format_message("info", message))

    def success(self, message):
        " Muestra un mensaje de éxito en la consola."
        self.console.success(format_message("success", message))

    def warning(self, message):
        " Muestra un mensaje de advertencia en la consola, incluyendo recomendaciones."
        enhanced_message = format_message("warning", message)
    ...
    def error(self, message):
        ...
        enhanced_message = format_message("error", message)
    ...
    def debug(self, message):
        ...
        self.console.debug(format_message("debug", message))
